...
- spread (espalhar): usado para dividir elementos de um array ou propriedades de um objeto para outro array/objeto.Útil para gerar novas estrutura de dados a partir de estruturas existentes.

- rest (coletar/extrair valores): usado para gerar uma lista de parâmetros par uma função à partir dos valores de um array.Útil para evitar a necessidade de criar manualmente em uma função, oupara quando não sabemos quantos parâmetros serão necessarios. 